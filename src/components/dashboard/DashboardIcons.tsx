...
export function IconSpecies(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IconSpecimens(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IconIdentifications(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IconHerbarium(props: IconProps) {
  return (
    <Icon {...props}>
      <rect width="18" height="18" x="3" y="3" rx="2" />
      <path d="M3 9h18" />
